    ...
    def handle_daily_digest(self):
        ...
        sample_items = [
            ...
            },
            {
                "id": 4,
                "title": "教育数字化转型的机遇与挑战",
                "summary": "疫情加速了教育数字化进程，但也暴露了数字鸿沟等问题。",
                "url": "https://example.com/education-digitalization",
                "source": "教育时报",
            ...
            {
                "id": 5,
                "title": "太空探索新里程碑：火星基地建设计划",
                "summary": "NASA宣布将在2030年前建立第一个永久性火星基地。",
                "url": "https://example.com/mars-base-plan",
                "source": "太空探索",
        ...
        # 随机选择3-5个项目
        selected_items = random.sample(sample_items, random.randint(3, 5))
    ...
    def handle_sources(self):
        ...
        sources = [
            ...
            },
            {
                "id": 3,
                "name": "科学网",
                "url": "https://example.com/science-net",
                "type": "rss",
                "status": "active",
